...
if (isset($_GET['remove'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM wishlist WHERE id = ? AND username = ?");
...
// Get wishlist items
$stmt = $conn->prepare("SELECT w.id AS wishlist_id, p.prod_id, p.name, p.price, p.image1 
                        FROM wishlist w 
    ...
    <div class="wishlist-container">
      ...
      <div id="wishlist-items" class="wishlist-items">
        ...
        if($wishlist_result->num_rows > 0) {
            // Display wishlist items from database
                ...
                <div class="wishlist-item">
                    ...
                    <div class="item-details">
                        ...
                        <div class="wishlist-actions">
                            <a href="../product/product.php?id=<?php echo $row['prod_id']; ?>" class="view-item">View Product</a>
                            <a href="wishlist.php?remove=<?php echo $row['wishlist_id']; ?>" class="remove-item">Remove</a>
                        </div>
                    </div>
                </div>
                <?php
            ...
            echo '<div class="wishlist-empty" id="wishlist-empty">
